...
public class BaseConfig : BaseConfigV0 {
	...
	static private BaseConfig Migrate(BaseConfigV0 config) {
		...
		var baseConfig = new BaseConfig {
			...
			EasyTierNodesApiUrl = config.EasyTierNodesApiUrl,
			EasyTierCommunitySessionToken = config.EasyTierCommunitySessionToken,
			EasyTierCommunityUsername = config.EasyTierCommunityUsername,
